  ...
  return (
    <section className={`flex flex-col gap-3 `}>
      ...
      <ExternalLink href="https://github.com/danielcgilibert">
        <div
          className={`flex  gap-2 justify-around items-center rounded-lg px-4 border-2 border-lightGray w-full h-16  hover:bg-lightBrown hover:bg-opacity-30  delay-75`}>
